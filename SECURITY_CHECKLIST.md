...
| S-06 | 대회 소유자 검증 (IDOR) | P0 | 완료 | ownership.ts 헬퍼, 12개 엔드포인트 적용 + curl 검증(403/200). 참가자 승인/수정/삭제·신청 거절/삭제·직접등록에도 소유자 검증 확장 (비소유 조직자 403 실측) |
...
| S-13 | 대량조회 페이징 | P3 | 완료 | parsePagination(기본100·최대500)을 participants/tournaments/matches/groups/teams/registration-requests/notices 목록에 적용 (curl limit=1 검증) |
...
| S-17 | WS 구독 범위 제한 | P3 | 완료 | /ws upgrade 시 소유 운영자 또는 해당 대회 참가자만 허용(co-process). 소유자 101 / 비소유 403 / 무효토큰 401 (curl 검증) |
